...
const Simple = ({ mapformat, id, setId, setMapStatus,setSelectedRegionType }) => {
                        ...
                        <Box sx={{ display: "flex", flexDirection: "column", }}>
                            <FormControl>
                                ...
                                <RadioGroup row defaultValue="both" onChange={(e) => setRegionType(e.target.value)} >
                                    <FormControlLabel control={<Radio />} value="both" label="Both"></FormControlLabel>
                                    <FormControlLabel control={<Radio />} value="kommuner" label="Kommune"></FormControlLabel>
                                    <FormControlLabel control={<Radio />} value="fylker" label="Fylke"></FormControlLabel>
                                </RadioGroup>
                            </FormControl>
