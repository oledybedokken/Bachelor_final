        ...
        <Grid container spacing={4} alignItems="center" justifyContent={"center"} sx={{ py: "5%" }}>
            <Grid item xs={6}>
                <Box sx={{ display: "flex", flexDirection: "column", height: "100%", justifyContent: "center", gap: "25px", pl: "5%" }}>
                    ...
                    <Box>
                        <Button variant={colorMode==="dark"?"outlined":"contained"} color="secondary" size="large" component={RouterLink} to={"/ssb"}sx={{ borderRadius: "25px" }} endIcon={<ArrowForwardIcon />}>
                            Explore SSB!
                        </Button>
                    </Box>
                </Box>
